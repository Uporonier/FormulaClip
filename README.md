...
- API 配置页提供“测试连接”，可直接验证地址、密钥和模型列表是否可用。
...
保存前可点击 **测试连接**。程序会使用当前地址和密钥请求模型列表，并显示成功、HTTP 错误或网络错误原因；测试成功后即可开始截图识别。
...
![Formula Clip 实际识别界面](docs/interface-real-v2.png)

![Formula Clip 实际历史记录界面](docs/history-real-v2.png)

![Formula Clip 实际设置界面](docs/settings-real-v2.png)
